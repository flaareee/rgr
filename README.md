...
<main>
    ...
    <section id="news" class="news-section">
        ...
        <article>
            <h3>Державний Ермітаж: перлина Санкт-Петербурга</h3>
            <p>Державний Ермітаж у Санкт-Петербурзі є одним з найбільших і найвідоміших музеїв світу. Заснований у 1764 році імператрицею Катериною II, він містить понад три мільйони творів мистецтва і культурних артефактів.</p>
            <!-- фото -->
            <div class="photos">
                <img src="hermitage1.jpg" alt="Державний Ермітаж">
                <img src="hermitage2.jpg" alt="Державний Ермітаж">
                <!-- додайте інші фото за бажанням -->
            </div>
        </article>
        <article>
            <h3>Третьяковська галерея: скарбниця російського мистецтва</h3>
            <p>Третьяковська галерея в Москві — головний музей російського образотворчого мистецтва. Заснована в 1856 році купцем Павлом Третьяковим, вона містить унікальну колекцію російського мистецтва від іконопису до сучасності.</p>
            <!-- фото -->
            <div class="photos">
                <img src="tretyakov1.jpg" alt="Третьяковська галерея">
                <img src="tretyakov2.jpg" alt="Третьяковська галерея">
                <!-- додайте інші фото за бажанням -->
            </div>
        </article>
        <article>
